...
public class GeradorDePagamento {
	...
	private LocalDate proximoDiaUtil(LocalDate dataBase) {
		...
		if(diaDaSemana == DayOfWeek.SATURDAY) {
			System.out.println("para Vencimento no Sabado considerar pagamento para proximo dia util sem encargos ");
			return dataBase.plusDays(2);
		}else if (diaDaSemana == DayOfWeek.SUNDAY) {
			System.out.println("para Vencimento no Domingo considerar pagamento para proximo dia util sem encargos ");
